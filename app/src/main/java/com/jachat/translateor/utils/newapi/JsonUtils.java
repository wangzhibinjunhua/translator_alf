package com.jachat.translateor.utils.newapi;
...
public class JsonUtils {
    ...
    /**
     * Google Gson的注解常用的版本号常量 - 1.0
     */
    public static final Double SINCE_VERSION_10 = 1.0d;
    /**
     * Google Gson的注解常用的版本号常量 - 1.1
     */
    public static final Double SINCE_VERSION_11 = 1.1d;
    /**
     * Google Gson 注解常用的版本号常量 - 1.2
     */
    ...
    /**
     * 将给定的目标对象转换成 JSON 格式的字符串。此方法只用来转换普通的JavaBean对象。
     * 该方法只会转换标有   注解的字段；
     * 该方法不会转换 null 值字段；
     * 该方法会转换所有未标注或已标注的字段；
